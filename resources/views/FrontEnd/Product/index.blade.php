            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="slider slider-nav mt-4">
                        @foreach ($product->productimage as $image)
                            <div>
                                <img src="{{ asset($image->image) }}" alt="" class="w-100 rounded " />
                            </div>
                        @endforeach
                    </div>
                </div>
                            ...
                            <span
                                ...
                                <span>
                                    ...
                                    @php
                                        ...
                                        $percentage = (($original_price - $selling_price)/$original_price)*100
                                        
                                    @endphp
                                    {{number_format($percentage,0)}}% off
                                </small>
                            </span>
                        </div>
                    ...
                    <ul class="nav nav-pills nav-lb-tab" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <!-- btn --> <button class="nav-link" id="sellerInfo-tab" data-bs-toggle="tab"
                                ...
                                aria-controls="sellerInfo-tab-pane" aria-selected="false" disabled>Seller
                                Info</button>
                        </li>
                    </ul>
                    <!-- tab content -->
                        ...
                        <div class="tab-pane fade show active" id="product-tab-pane" role="tabpanel"
                            ...
                            <div class="my-8">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Image shown is a representation and may slightly vary from the actual
                                        product. Every
                                        effort
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <span>
                                                    <!-- rating --> <small class="text-warning"> <i
                                                        ...
                                                        <i class="bi bi-star-fill"></i>
                                                        <i class="bi bi-star-fill"></i>
                                                        <i class="bi bi-star-half"></i></small><span class="ms-3">4.1
                                                        out of 5</span><small class="ms-3">11,130 global
                                                        ratings</small></span>
                                            </div>
                                            <div class="mb-8">
                                                <!-- progress -->
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div class="d-flex border-bottom pb-6 mb-6">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <!-- text-->
                                                    <p>Product quality is good. But, weight seemed less than 1kg. Since it
                                                        is being sent in open
                                                        package, there is a possibility of pilferage in between. FreshCart
                                                        sends the veggies and
                                                        fruits through sealed plastic covers and Barcode on the weight etc.
                                                        .</p>
                                                    <div>
                                            ...
                                            <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                <!-- img --><img src="../assets/images/avatar/avatar-12.jpg"
                                                    alt="" class="rounded-circle avatar-lg">
                                                <div class="ms-5">
                                                    <h6 class="mb-1">
                                                        Robert Thomas
